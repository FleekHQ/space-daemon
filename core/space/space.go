...
type Service interface {
	...
	ListDirs(ctx context.Context, path string, bucketName string, listSubfolderContent bool, listMembers bool) ([]domain.FileInfo, error)
	ListDir(ctx context.Context, path string, bucketName string, listSubfolderContent bool, listMembers bool) ([]domain.FileInfo, error)
