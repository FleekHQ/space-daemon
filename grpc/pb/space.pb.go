...
var file_space_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x42, 0x0a, 0x09, 0x45, 0x76,
	...
	0x4e, 0x54, 0x52, 0x59, 0x5f, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x22,
	...
	0x10, 0x00, 0x2a, 0x3b, 0x0a, 0x10, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0xbb, 0x17, 0x0a, 0x08, 0x53, 0x70, 0x61, 0x63, 0x65, 0x41, 0x70, 0x69, 0x12, 0x6d, 0x0a, 0x0f,
	...
	0x69, 0x6c, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x3a, 0x01, 0x2a, 0x12, 0x6b, 0x0a, 0x0e, 0x4f, 0x70,
	...
	0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x2f, 0x7b, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x7d,
	0x2f, 0x6a, 0x6f, 0x69, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x9b, 0x01, 0x0a, 0x17, 0x53, 0x68, 0x61,
	0x72, 0x65, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x56, 0x69, 0x61, 0x50, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x4b, 0x65, 0x79, 0x12, 0x25, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x2e, 0x53, 0x68, 0x61,
	0x72, 0x65, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x56, 0x69, 0x61, 0x50, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x73, 0x70,
	...
	0x7d, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x56, 0x69, 0x61, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63,
	...
	0x76, 0x31, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x2f, 0x7b, 0x49, 0x44, 0x7d, 0x2f, 0x72, 0x65, 0x61, 0x64, 0x3a, 0x01, 0x2a, 0x42, 0x06, 0x5a,
...
var file_space_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
...
var file_space_proto_depIdxs = []int32{
	...
	55, // 19: space.SpaceApi.Subscribe:input_type -> google.protobuf.Empty
	55, // 20: space.SpaceApi.TxlSubscribe:input_type -> google.protobuf.Empty
	16, // 21: space.SpaceApi.OpenFile:input_type -> space.OpenFileRequest
	36, // 22: space.SpaceApi.GeneratePublicFileLink:input_type -> space.GeneratePublicFileLinkRequest
	18, // 23: space.SpaceApi.OpenPublicFile:input_type -> space.OpenPublicFileRequest
	20, // 24: space.SpaceApi.AddItems:input_type -> space.AddItemsRequest
	23, // 25: space.SpaceApi.CreateFolder:input_type -> space.CreateFolderRequest
	38, // 26: space.SpaceApi.ToggleFuseDrive:input_type -> space.ToggleFuseRequest
	55, // 27: space.SpaceApi.GetFuseDriveStatus:input_type -> google.protobuf.Empty
	8,  // 28: space.SpaceApi.CreateBucket:input_type -> space.CreateBucketRequest
	25, // 29: space.SpaceApi.BackupKeysByPassphrase:input_type -> space.BackupKeysByPassphraseRequest
	27, // 30: space.SpaceApi.RecoverKeysByPassphrase:input_type -> space.RecoverKeysByPassphraseRequest
	30, // 31: space.SpaceApi.ShareBucket:input_type -> space.ShareBucketRequest
	32, // 32: space.SpaceApi.JoinBucket:input_type -> space.JoinBucketRequest
	34, // 33: space.SpaceApi.ShareBucketViaPublicKey:input_type -> space.ShareBucketViaPublicKeyRequest
	46, // 34: space.SpaceApi.AcceptBucketInvitation:input_type -> space.AcceptBucketInvitationRequest
	48, // 35: space.SpaceApi.RejectBucketInvitation:input_type -> space.RejectBucketInvitationRequest
	55, // 36: space.SpaceApi.NotificationSubscribe:input_type -> google.protobuf.Empty
	40, // 37: space.SpaceApi.ListBuckets:input_type -> space.ListBucketsRequest
	42, // 38: space.SpaceApi.CopyAndShareFiles:input_type -> space.CopyAndShareFilesRequest
	51, // 39: space.SpaceApi.GetNotifications:input_type -> space.GetNotificationsRequest
	53, // 40: space.SpaceApi.ReadNotification:input_type -> space.ReadNotificationRequest
	5,  // 41: space.SpaceApi.ListDirectories:output_type -> space.ListDirectoriesResponse
	7,  // 42: space.SpaceApi.ListDirectory:output_type -> space.ListDirectoryResponse
	13, // 43: space.SpaceApi.GenerateKeyPair:output_type -> space.GenerateKeyPairResponse
	13, // 44: space.SpaceApi.GenerateKeyPairWithForce:output_type -> space.GenerateKeyPairResponse
	14, // 45: space.SpaceApi.Subscribe:output_type -> space.FileEventResponse
	15, // 46: space.SpaceApi.TxlSubscribe:output_type -> space.TextileEventResponse
	17, // 47: space.SpaceApi.OpenFile:output_type -> space.OpenFileResponse
	37, // 48: space.SpaceApi.GeneratePublicFileLink:output_type -> space.GeneratePublicFileLinkResponse
	19, // 49: space.SpaceApi.OpenPublicFile:output_type -> space.OpenPublicFileResponse
	22, // 50: space.SpaceApi.AddItems:output_type -> space.AddItemsResponse
	24, // 51: space.SpaceApi.CreateFolder:output_type -> space.CreateFolderResponse
	39, // 52: space.SpaceApi.ToggleFuseDrive:output_type -> space.FuseDriveResponse
	39, // 53: space.SpaceApi.GetFuseDriveStatus:output_type -> space.FuseDriveResponse
	11, // 54: space.SpaceApi.CreateBucket:output_type -> space.CreateBucketResponse
	26, // 55: space.SpaceApi.BackupKeysByPassphrase:output_type -> space.BackupKeysByPassphraseResponse
	28, // 56: space.SpaceApi.RecoverKeysByPassphrase:output_type -> space.RecoverKeysByPassphraseResponse
	31, // 57: space.SpaceApi.ShareBucket:output_type -> space.ShareBucketResponse
	33, // 58: space.SpaceApi.JoinBucket:output_type -> space.JoinBucketResponse
	35, // 59: space.SpaceApi.ShareBucketViaPublicKey:output_type -> space.ShareBucketViaPublicKeyResponse
	47, // 60: space.SpaceApi.AcceptBucketInvitation:output_type -> space.AcceptBucketInvitationResponse
	49, // 61: space.SpaceApi.RejectBucketInvitation:output_type -> space.RejectBucketInvitationResponse
	50, // 62: space.SpaceApi.NotificationSubscribe:output_type -> space.NotificationEventResponse
	41, // 63: space.SpaceApi.ListBuckets:output_type -> space.ListBucketsResponse
	43, // 64: space.SpaceApi.CopyAndShareFiles:output_type -> space.CopyAndShareFilesResponse
	52, // 65: space.SpaceApi.GetNotifications:output_type -> space.GetNotificationsResponse
	54, // 66: space.SpaceApi.ReadNotification:output_type -> space.ReadNotificationResponse
