...
var file_space_proto_rawDesc = []byte{
	...
	0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x32, 0xe1, 0x04, 0x0a, 0x08, 0x53, 0x70, 0x61, 0x63, 0x65,
	...
	0x12, 0x3d, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x16, 0x2e, 0x73,
	...
	0x49, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x46, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x12,
...
var file_space_proto_goTypes = []interface{}{
	...
	(*OpenFileRequest)(nil),         // 8: space.OpenFileRequest
	(*OpenFileResponse)(nil),        // 9: space.OpenFileResponse
	(*AddItemsRequest)(nil),         // 10: space.AddItemsRequest
	(*AddItemResult)(nil),           // 11: space.AddItemResult
	(*AddItemError)(nil),            // 12: space.AddItemError
...
var file_space_proto_depIdxs = []int32{
	...
	11, // 3: space.AddItemsResponse.results:type_name -> space.AddItemResult
	12, // 4: space.AddItemsResponse.errors:type_name -> space.AddItemError
	1,  // 5: space.SpaceApi.ListDirectories:input_type -> space.ListDirectoriesRequest
	16, // 6: space.SpaceApi.GetConfigInfo:input_type -> google.protobuf.Empty
	...
	16, // 9: space.SpaceApi.Subscribe:input_type -> google.protobuf.Empty
	8,  // 10: space.SpaceApi.OpenFile:input_type -> space.OpenFileRequest
	10, // 11: space.SpaceApi.AddItems:input_type -> space.AddItemsRequest
	...
	9,  // 18: space.SpaceApi.OpenFile:output_type -> space.OpenFileResponse
	13, // 19: space.SpaceApi.AddItems:output_type -> space.AddItemsResponse
	15, // 20: space.SpaceApi.CreateFolder:output_type -> space.CreateFolderResponse
