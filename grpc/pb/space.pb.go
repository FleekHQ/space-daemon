...
type ConfigInfoResponse struct {
	...
	AppPath    string `protobuf:"bytes,3,opt,name=appPath,proto3" json:"appPath,omitempty"`
}
...
func (x *ConfigInfoResponse) GetFolderPath() string {
	if x != nil {
		return x.FolderPath
	}
	return ""
...
func (x *AddItemError) GetSourcePath() string {
	if x != nil {
		return x.SourcePath
	}
	return ""
...
func (x *AddItemError) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type AddItemsResponse struct {
	...
	Results []*AddItemResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	Errors  []*AddItemError  `protobuf:"bytes,2,rep,name=errors,proto3" json:"errors,omitempty"`
}
...
func (x *AddItemsResponse) GetResults() []*AddItemResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *AddItemsResponse) GetErrors() []*AddItemError {
	if x != nil {
		return x.Errors
	}
	return nil
...
var file_space_proto_rawDesc = []byte{
	...
	0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x62, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e,
	0x0a, 0x0a, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x50, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x50, 0x61, 0x74, 0x68, 0x12, 0x12,
	0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f,
	0x72, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x70, 0x70, 0x50, 0x61, 0x74, 0x68, 0x18, 0x03, 0x20,
	...
	0x67, 0x65, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0x4f, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x49, 0x74,
	...
	0x63, 0x6b, 0x65, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0x44, 0x0a, 0x0c, 0x41, 0x64, 0x64, 0x49,
	0x74, 0x65, 0x6d, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x1e, 0x0a, 0x0a, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x50, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x50, 0x61, 0x74, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f,
	...
	,
	...
	0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x32, 0xaa, 0x05, 0x0a, 0x08, 0x53, 0x70, 0x61, 0x63, 0x65,
	0x41, 0x70, 0x69, 0x12, 0x52, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x69, 0x72, 0x65, 0x63,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x44, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x43, 0x6f,
	...
	0x01, 0x12, 0x47, 0x0a, 0x0c, 0x54, 0x78, 0x6c, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3d, 0x0a, 0x08, 0x4f, 0x70,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61,
...
var file_space_proto_goTypes = []interface{}{
	...
	(*AddItemError)(nil),            // 13: space.AddItemError
...
var file_space_proto_depIdxs = []int32{
	...
	12, // 3: space.AddItemsResponse.results:type_name -> space.AddItemResult
	13, // 4: space.AddItemsResponse.errors:type_name -> space.AddItemError
	1,  // 5: space.SpaceApi.ListDirectories:input_type -> space.ListDirectoriesRequest
	17, // 6: space.SpaceApi.GetConfigInfo:input_type -> google.protobuf.Empty
	5,  // 7: space.SpaceApi.GenerateKeyPair:input_type -> space.GenerateKeyPairRequest
	5,  // 8: space.SpaceApi.GenerateKeyPairWithForce:input_type -> space.GenerateKeyPairRequest
	17, // 9: space.SpaceApi.Subscribe:input_type -> google.protobuf.Empty
	17, // 10: space.SpaceApi.TxlSubscribe:input_type -> google.protobuf.Empty
	9,  // 11: space.SpaceApi.OpenFile:input_type -> space.OpenFileRequest
	11, // 12: space.SpaceApi.AddItems:input_type -> space.AddItemsRequest
	15, // 13: space.SpaceApi.CreateFolder:input_type -> space.CreateFolderRequest
	3,  // 14: space.SpaceApi.ListDirectories:output_type -> space.ListDirectoriesResponse
	4,  // 15: space.SpaceApi.GetConfigInfo:output_type -> space.ConfigInfoResponse
	6,  // 16: space.SpaceApi.GenerateKeyPair:output_type -> space.GenerateKeyPairResponse
	6,  // 17: space.SpaceApi.GenerateKeyPairWithForce:output_type -> space.GenerateKeyPairResponse
	7,  // 18: space.SpaceApi.Subscribe:output_type -> space.FileEventResponse
	8,  // 19: space.SpaceApi.TxlSubscribe:output_type -> space.TextileEventResponse
	10, // 20: space.SpaceApi.OpenFile:output_type -> space.OpenFileResponse
	14, // 21: space.SpaceApi.AddItems:output_type -> space.AddItemsResponse
	16, // 22: space.SpaceApi.CreateFolder:output_type -> space.CreateFolderResponse
...
func (c *spaceApiClient) AddItems(ctx context.Context, in *AddItemsRequest, opts ...grpc.CallOption) (*AddItemsResponse, error) {
	out := new(AddItemsResponse)
	err := c.cc.Invoke(ctx, "/space.SpaceApi/AddItems", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSpaceApiServer) AddItems(context.Context, *AddItemsRequest) (*AddItemsResponse, error) {
...
func _SpaceApi_AddItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddItemsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SpaceApiServer).AddItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/space.SpaceApi/AddItems",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpaceApiServer).AddItems(ctx, req.(*AddItemsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
