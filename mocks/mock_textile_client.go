...
func (_m *Client) MarkMirrorFileBackup(ctx context.Context, _a1 string, bucketSlug string) (*textile.MirrorFile, error) {
	ret := _m.Called(ctx, _a1, bucketSlug)

	var r0 *textile.MirrorFile
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *textile.MirrorFile); ok {
		r0 = rf(ctx, _a1, bucketSlug)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*textile.MirrorFile)
		}
	}
